...
import { usePlayerId, getStoredPlayerId, clearStoredPlayerId } from './usePlayerId';
...
describe('usePlayerId', () => {
  ...
  it('handles error when creating player fails', async () => {
    ...
    vi.spyOn(createPlayerApi, 'createPlayer').mockRejectedValue(new Error(errorMessage));
  ...
  it('cleans up on unmount', async () => {
    ...
    vi.spyOn(createPlayerApi, 'createPlayer').mockReturnValue(createPromise as any);
