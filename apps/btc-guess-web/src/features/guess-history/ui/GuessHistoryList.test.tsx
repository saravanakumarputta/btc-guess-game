...
describe('GuessHistoryList', () => {
  it('renders the card title and description', () => {
    ...
    expect(screen.getByText('Your recent guesses and results')).toBeInTheDocument();
  });

  it('displays loading state', () => {
    const { container } = render(<GuessHistoryList guesses={[]} isLoading={true} />);
  ...
  it('displays empty state when no guesses', () => {
    ...
    expect(screen.getByText('Place a guess above to see it here')).toBeInTheDocument();
  });
    ...
    const guesses: GuessRecord[] = [
      {
        ...
        resolvedAt: '2024-03-01T12:01:00Z',
      },
    ];
  ...
  it('handles guesses without entry price', () => {
    const guesses: GuessRecord[] = [
      {
        guessId: '1',
        playerId: 'player1',
